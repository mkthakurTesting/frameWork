...
public class Element {
	...
	public static void click(WebDriver driver, By locator) {
		...
		if (Wait.checkElementExistance(driver, 30, 5, locator)) {
			...
			//ExtentReport.et.log(LogStatus.INFO, " click()... executed on " + locator);
		} else {
			logger.info(" click () failed from execution on element  " + locator);
			//ExtentReport.et.log(LogStatus.INFO, " click ()... failed from execution on element  " + locator);
		}
	...
	public static void submit(WebDriver driver, By locator) {
		...
		if (Wait.checkElementExistance(driver, 30, 5, locator)) {
			...
			//ExtentReport.et.log(LogStatus.INFO, "submit()... Executed On" + locator);
		} else {
			logger.info("submit()... failed from execution on " + locator);
			//ExtentReport.et.log(LogStatus.INFO, "submit()... failed from execution on " + locator);
		}
